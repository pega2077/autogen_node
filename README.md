...
For detailed documentation on all tools, see [TOOLS.md](./TOOLS.md).
...
- [ADVANCED_AGENTS.md](./ADVANCED_AGENTS.md) - ConversableAgent, RAG, GPT Assistant, Multimodal, etc.
- [PLANNER_SUPERVISOR.md](./PLANNER_SUPERVISOR.md) - Planning and Supervision workflow (English)
- [PLANNER_SUPERVISOR_CN.md](./PLANNER_SUPERVISOR_CN.md) - Planning and Supervision workflow (中文)
...
- [x] Advanced agent types
  ...
  - [x] PlannerAgent (task planning and decomposition)
  - [x] SupervisorAgent (task verification and feedback)
...
- [x] Tools & Extensions
  - [x] File System Tools (read/write/directory operations)
  - [x] Browser Tools (Playwright web automation)
  - [x] Docker Code Executor (isolated code execution)
  - [x] API Tools (REST/GraphQL wrappers)
  - [x] Image Generation Tools (DALL-E integration)
  - [x] Database Tools (SQL/NoSQL interfaces)
  - [x] Tool Caching (result caching with eviction strategies)
